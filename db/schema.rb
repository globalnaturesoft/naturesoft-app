...
ActiveRecord::Schema.define(version: 20160811032743) do
  ...
  create_table "naturesoft_products_parent_categories", force: :cascade do |t|
    t.integer  "parent_id"
    t.integer  "category_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["category_id"], name: "index_naturesoft_products_parent_categories_on_category_id", using: :btree
  end
  ...
  create_table "naturesoft_projects_images", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_naturesoft_projects_images_on_user_id", using: :btree
  end
